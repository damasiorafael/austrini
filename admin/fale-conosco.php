                                    ...
                                    <table id="example2" class="table table-bordered table-hover table-austrini">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="th-mensagem">Mensagem</th>
                                        ...
                                        <tbody>
                                            <?php
                                                $sqlConsulta    = "SELECT *, date_format(data, '%d/%m/%Y') AS data FROM contatos";
                                            ...
                                            <tr>
                                                ...
                                                <td class="content-cidade"><?php echo $consulta->cidade; ?></td>
                                                <td class="content-telefone"><?php echo $consulta->telefone; ?></td>
                                                <td class="content-mensagem"><?php echo $consulta->mensagem; ?></td>
                                                ...
                                                <td class="content-botoes-acoes">
                                                    <a href="fale-conosco-acoes.php?id=<?php echo $consulta->id; ?>&acao=delete" class="btn btn-danger btn-sm btn-delete"><i class="fa fa-times"></i> Excluir</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
