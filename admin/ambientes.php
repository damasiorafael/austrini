                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <a href="ambientes-add-edit.php" class="btn btn-success btn-lg btn-adicionar pull-right"><i class="fa fa-plus"></i> Adicionar</a>
                                    <table id="example2" class="table table-bordered table-hover table-austrini">
                                        ...
                                        <tbody>
                                            <?php
                                                $sqlConsulta    = "SELECT *, date_format(data, '%d/%m/%Y') AS data FROM ambientes";
                                            ...
                                            <tr>
                                                ...
                                                <td class="content-botoes-acoes">
                                                    <a href="ambientes-add-edit.php?id=<?php echo $consulta->id; ?>&acao=edit" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> Editar</a>
                                                    <a href="ambientes-acoes.php?id=<?php echo $consulta->id; ?>&acao=delete" class="btn btn-danger btn-sm btn-delete"><i class="fa fa-times"></i> Excluir</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
