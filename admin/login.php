<?php
    ...
    if((isset($_POST['username']) == true) and (isset($_POST['senha']) == true)){
        ...
        $sqlUser            = "SELECT username FROM users WHERE username = '$username' AND status = '1'";
        ...
        if($numRowsUser > 0){
            ...
            $sqlSenha               = "SELECT senha FROM users WHERE username = '".$_SESSION['username']."' AND senha = '".SHA1($senha)."'";
...
<html class="bg-gray">
    <head>
        <meta charset="UTF-8">
        <title>Admin - Austrini | Login</title>
    ...
    <body class="bg-gray">
        <div class="form-box" id="login-box">
            ...
            <form action="login.php" method="post">
                ...
                <div class="footer">
                    <button type="submit" class="btn btn-info btn-block btn-austrini bg-austrini">Entrar</button>
                </div>
            </form>
        </div>
