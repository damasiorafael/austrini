                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table id="example2" class="table table-bordered table-hover table-austrini">
                                        ...
                                        <tbody>
                                            <?php for($i=1; $i<=9; $i++) { ?>
                                            <tr>
                                                <td class="content-id">1</td>
                                                <td class="content-img">
                                                    <img src="../uploads/destaque-1.jpg" />
                                                </td>
                                                <td class="content-data">01/01/2015</td>
                                                ...
                                                <td class="content-botoes-acoes">
                                                    ...
                                                    <a href="" class="btn btn-danger btn-sm"><i class="fa fa-times"></i> Excluir</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
