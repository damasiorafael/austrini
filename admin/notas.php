        ...
        <div class="wrapper row-offcanvas row-offcanvas-left austrini">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Notas dos Arquitetos
                        <small>Austrini</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Notas dos Arquitetos</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Notas dos Arquitetos</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive">
                                    <a href="notas-add-edit.php" class="btn btn-success btn-lg btn-adicionar pull-right"><i class="fa fa-plus"></i> Adicionar</a>
                                    <table id="example2" class="table table-bordered table-hover table-austrini">
                                        <thead>
                                            <tr>
                                                <th class="th-id">ID</th>
                                                <th class="th-titulo">Nome</th>
                                                <th class="th-texto">Nota</th>
                                                <th>Imagem</th>
                                        ...
                                        <tbody>
                                            <?php
                                                $sqlConsulta    = "SELECT *, date_format(data, '%d/%m/%Y') AS data FROM notas";
                                            ...
                                            <tr>
                                                ...
                                                <td class="content-texto"><?php echo $consulta->nota; ?></td>
                                                ...
                                                <td class="content-botoes-acoes">
                                                    <a href="notas-add-edit.php?id=<?php echo $consulta->id; ?>&acao=edit" class="btn btn-warning btn-sm"><i class="fa fa-pencil"></i> Editar</a>
                                                    <a href="notas-acoes.php?id=<?php echo $consulta->id; ?>&acao=delete" class="btn btn-danger btn-sm btn-delete"><i class="fa fa-times"></i> Excluir</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
